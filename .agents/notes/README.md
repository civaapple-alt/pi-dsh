...
| `2026-08-19` | [Visual Capability Seam & Plugin Dependency Graph on Cordis](implemented/architecture/2026-08-19-capability-seam-dependency-graph.md) | Koishi-style interactive dependency graph, DSH Capability Seam Triad (Provider/Consumer/Definition), 4-column hierarchical DAG flow layout, adaptive dual-theme, and Inspector Drawer |

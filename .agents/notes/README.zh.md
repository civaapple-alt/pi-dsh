...
| 提出日期 | 决策标题 | 核心主题 |
| `2026-08-19` | [基于 Cordis 的全栈能力接缝与微前端可视化依赖图](implemented/architecture/2026-08-19-capability-seam-dependency-graph.zh.md) | Koishi 风格拓扑依赖图、DSH 能力接缝三位一体（Provider/Consumer/Definition）、四列分层拓扑流水线布局、双主题动态自适应与 Inspector 检查器 |
